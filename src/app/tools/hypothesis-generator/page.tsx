    ...
    <div className="p-4 md:p-6 lg:p-8">
      ...
      >
        ...
        <div className="rounded-lg border-2 border-[#023840] bg-[#023840]/5 p-4 md:text-lg dark:border-[#7bf179] dark:bg-[#7bf179]/5">
          🎉 This is an experimental tool meant for creative exploration! We
          might showcase the most amusing and entertaining ideas on our platform
          to spread joy and inspire others. If you have a serious business idea
          that you want to keep confidential, please use our{' '}
          <Link
            href="/start"
